...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $Type = "Faculty";
    $Fines = 0;
    $Facult_type = $_POST["faculty_type"];
    ...
    $id = $_POST['fixed_value'];
        ...
        $counting = "Select count(*) from customer where type='faculty'";
        ...
        if($new_record<10){
            $Membeship_ID='F00'.$new_record;
        }elseif($new_record<100){
            $Membeship_ID='F0'.$new_record;
        }else{
            $Membeship_ID='F'.$new_record;
        }
...
<header>
      ...
      <div class="wrapper">
            ...
            <form action="faculty_profile.php" method="post">
                  ...
                  <div class="input-box">
                        <span class="icon"><ion-icon name="lock-closed-outline"></ion-icon></span>
                        <input type="faculty_type" class="form-control" id="faculty_type" name="faculty_type">
                        <label for="faculty_type">faculty_type</label>
