...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $Phone = $_POST["phone"];
    $Off_day = intval($_POST["Off_day"],10);
    $Type = "Cook";
    ...
    $id = $_POST['fixed_value'];
        ...
        $counting = "Select count(*) from employee where type='Cook'";
        ...
        if($new_record<10){
            $Membeship_ID='EC00'.$new_record;
        }elseif($new_record<100){
            $Membeship_ID='EC0'.$new_record;
        }else{
            $Membeship_ID='EC'.$new_record;
        }
...
<body>
      ...
      <div class="wrapper">
            ...
            <form action="cook_profile.php" method="post">
                  ...
                  <div class="input-box">
                        <span class="icon"><ion-icon name="lock-closed-outline"></ion-icon></span>
                        <input type="Off_day" class="form-control" id="Off_day" name="Off_day">
